  ...
  return (
    <div className="relative pt-8 lg:pt-0">
      <div className="flex flex-col flex-1 gap-5">
        ...
        <div className="pt-4 w-full sm:w-9/12 lg:w-8/12 lg:w-8/12 xl:w-7/12">
          <p
            className={
              "text-sm sm:text-base lg:text-lg lg:text-lg xl:text-xl font-light leading-relaxed text-apple-black"
            }
          >
