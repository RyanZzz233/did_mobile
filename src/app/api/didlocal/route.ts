...
export async function GET(request: NextRequest) {
  ...
  // const url = `${process.env.PUBLIC_ENDPOINT}/getSpecTransactions?key=${key}&value=${value}&page=${page}`;
  const url = new URL("getSpecTransactions", process.env.PUBLIC_ENDPOINT);
