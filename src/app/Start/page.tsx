    ...
    <div className="flex">
      ...
      <div className="fixed top-0 left-0 bottom-0 w-full lg:w-1/2 flex flex-col justify-start border-r border-grey transition-width duration-300 ease-in-out bg-apple-grey">
        <div className="pt-36 pl-12 pr-8">
          <h1
            className={
            "relative text-xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-4xl font-extrabold leading-tight tracking-tighter text-left pb-2 bg-gradient-to-r from-tw-purple via-tw-blue to-tw-blue text-transparent bg-clip-text"
          }
          style={{
            ...
            <div className="">
              <form onSubmit={addItem}>
                <div className="">
                  <p
                    className={
                      "flex w-3/4 lg:w-full text-lg font-light text-sm sm:text-sm md:text-sm lg:text-lg xl:text-xl leading-relaxed text-apple-black pt-12 pb-4"
                    }
                  >
